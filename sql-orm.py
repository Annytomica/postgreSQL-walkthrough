from sqlalchemy import (
    create_engine, Column, Float, ForeignKey, Integer, String, MetaData
)
...
# use .first to only get first item from query - based on assumption there should only be one entry for 'queen'
...
# Query 6 - select only tracks with 'composer' "Queen" from the "Track" table
